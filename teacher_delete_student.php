<?php
		...
		session_start();
		$query1 = "DELETE FROM `ats_combine` WHERE `ats_combine`.`usn` = '$_POST[delete_student]' AND `ats_combine`.`t_id` = '$_SESSION[teacher_id]'";
        $result1 = mysqli_query($connection,$query1);
        if($result1){
            $query2 = "DELETE FROM `sss_combine` WHERE `sss_combine`.`sss_usn` = '$_POST[delete_student]' ";
